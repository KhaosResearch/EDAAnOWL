...
Welcome to the documentation for version 0.2.1 of the AgoraOWL ontology.
...
**The most notable change in this version** is that the documentation generated by widoco no longer describes the ontologies imported into AgoraOWL, in this way the documentation is more specific to our own ontology.

---

## 🧐 How the Ontology Fulfills Requirements (v0.2.1 Model)
