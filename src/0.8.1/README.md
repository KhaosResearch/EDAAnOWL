...
AgoraOWL v0.8.1 includes a complete example (`examples/cred-asset-example.ttl`) demonstrating how to annotate a data space asset following [CRED recommendations](https://espaciosdedatos.gob.es/), covering all 9 entity types:
