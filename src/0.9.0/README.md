...
In previous versions, properties were often implicitly tied to a measurement context. Version 0.9.0 introduces explicit support for `agoraowl:declaresFeatureOfInterest`:
...
AgoraOWL v0.9.0 continues to track the [CRED recommendations](https://espaciosdedatos.gob.es/) from the Spanish Data Office, ensuring that `dcat:Catalog`, `dcat:Dataset`, and `dcat:Distribution` metadata follow the UNE 0087:2025 standard.
...
AgoraOWL remains **external-first**. Key normative vocabularies integrated in v0.9.0:
...
| Spanish Sector   | [SIEX (local)](vocabularies/siex.ttl)        | `https://w3id.org/AgoraOWL/0.9.0/vocabularies/siex/*` |
