...
Welcome to the documentation for version 0.0.1 of the AgoraOWL ontology.
...
In this version, AgoraOWL fulfills the project's requirements by using a **Profile-based Compatibility Model**.

This model is ideal for structured data (like tables or time-series) where the data's _shape_ and _structure_ are key to determining compatibility.
